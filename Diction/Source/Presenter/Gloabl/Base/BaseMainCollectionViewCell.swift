//
//  BaseMainCollectionViewCell.swift
//  GreenLight
//
...
class BaseMainCollectionViewCell: UICollectionViewCell {
    ...
    func setQuestionCollectionViewCell(questions: Results<QuestionModel>, indexPath: IndexPath) {
        ...
        interviewDateLabel.text = questions[indexPath.row].createdDate.dateFormatter + "  | "
